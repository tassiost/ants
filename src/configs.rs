...
pub const SIM_FIXED_TIMESTEP_SECS: f32 = 1.0 / 60.0;

use bevy::prelude::*;

#[derive(Resource)]
pub struct DeterministicRng {
    pub inner: rand::rngs::StdRng,
}

#[derive(Resource)]
pub struct SpriteHandles {
    pub ant: Handle<Image>,
    pub ant_with_food: Handle<Image>,
}

#[derive(Resource)]
pub struct PheromoneImageBuffer(pub Vec<u8>);

#[derive(Resource)]
pub struct PathVizImageBuffer(pub Vec<u8>);
